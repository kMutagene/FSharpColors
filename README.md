...
1. Add links to GH project in all places marked `https://github.com/kMutagene/FSharpColors`
2. Add name of the author in all places marked `Kevin Schneider`
...
* Sample documentation produced by the template can be found on http://kcieslak.io/SampleFSharpColors.
...
* Use FSharp.Formatting to create API reference for the project - sample: http://kcieslak.io/SampleFSharpColors/Reference/ApiRef.html
* Use [Lunr.js](https://lunrjs.com/) to provide client side search based on generated by Fornax search index - sample: try searching for `Lorem` or `Sample` in search available on http://kcieslak.io/SampleFSharpColors
* Use [Mermaid.js](https://mermaid-js.github.io/mermaid/#/) to provide client side render diagrams and graphs - sample: http://kcieslak.io/SampleFSharpColors/diagrams.html
...
The project is hosted on [GitHub](https://github.com/kMutagene/FSharpColors) where you can report issues, fork
