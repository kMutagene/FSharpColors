...
let project = "FSharpColors"

let summary = "Library to provide utility functions for working with colors (rgb,hex,hsl,...) in F#"
let authors = "Kevin Schneider, Timo Mühlhaus"
let tags = "F# Colors Hex RGB HSL"
let copyright = "IDK"

let gitOwner = "Kevin Schneider"
let gitName = "FSharpColors"
...
Target.create "Test" (fun _ ->
    exec "dotnet"  @"run --project .\tests\FSharpColors.UnitTests\FSharpColors.UnitTests.fsproj" "."
)
